...
const color1Click = () => {
  ...
  const color2Click = () => {
    ...
    return(
        ...
        <MenuCircleBtn submenu={window.finalLangues.color1}  source="./img/clr_1.png"/>
        ...
        <AccordionDetails tabIndex="-1" id="blackBtn" onKeyPress={props.onBlackBtnClick} onClick={props.onBlackBtnClick}>
         <MenuCircleBtn id="blackBtns" submenu={window.finalLangues.color2} source="./img/clr_2.png"/>
